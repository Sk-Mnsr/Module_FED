        ...
        <form class="flex min-h-0 flex-1 flex-col gap-4 p-4 sm:p-6" @submit.prevent="submit">
            <section class="overflow-hidden rounded-2xl border border-border/80 bg-card shadow-sm">
                ...
                >
                    <div class="flex items-start gap-3">
                        <div
                            class="flex size-11 shrink-0 items-center justify-center rounded-xl bg-primary text-sm font-semibold text-primary-foreground shadow-sm"
                        >
                            {{ initials }}
                        </div>
                        <div>
            ...
            <section class="overflow-hidden rounded-2xl border border-border/80 bg-card shadow-sm">
                ...
                <div class="grid gap-4 p-5 sm:grid-cols-2">
                    <div>
                        ...
                        <Input id="name" v-model="form.name" type="text" required :class="fieldClass" />
                    ...
                    <div>
                        ...
                        <Input id="email" v-model="form.email" type="email" required :class="fieldClass" />
            ...
            <section class="overflow-hidden rounded-2xl border border-border/80 bg-card shadow-sm">
                <div class="flex items-start gap-3 border-b border-border/80 px-5 py-4">
                    ...
                    <div>
                        <h2 class="text-sm font-semibold text-foreground">Réinitialiser le mot de passe</h2>
                        <p class="text-xs text-muted-foreground">
                            Laissez vide pour conserver le mot de passe actuel. Sinon, l’utilisateur devra le
